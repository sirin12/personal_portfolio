    ...
    return (
        <div className="single-project-page-design">
            ...
            <div className="single-project-image">
                <Image  unoptimized width={1095} height={1072} sizes='100vw' style={{width:"100%", height:"auto"}} src={"/personal_portfolio/images/projects/single-project.jpg"} alt="image" />
            </div>
                ...
                <div className="row pt-30">
                    <div className="col-lg-6">
                        <div className="single-image wow fadeInUp delay-0-2s">
                            <Image  unoptimized width={633} height={679} sizes='100%' style={{width:"100%", height:"auto"}} src={"/personal_portfolio/images/projects/single-project1.jpg"} alt="gallery" />
                        </div>
                    </div>
                    <div className="col-lg-6">
                        <div className="single-image wow fadeInUp delay-0-4s">
                            <Image  unoptimized width={633} height={679} sizes='100%' style={{width:"100%", height:"auto"}} src={"/personal_portfolio/images/projects/single-project2.jpg"} alt="gallery" />
                        </div>
                    </div>
                    <div className="col-lg-6">
                        <div className="single-image wow fadeInUp delay-0-6s">
                            <Image  unoptimized width={633} height={679} sizes='100%' style={{width:"100%", height:"auto"}} src={"/personal_portfolio/images/projects/single-project3.jpg"} alt="gallery" />
                        </div>
                    </div>
                    <div className="col-lg-6">
                        <div className="single-image wow fadeInUp delay-0-8s">
                            <Image  unoptimized width={633} height={679} sizes='100%' style={{width:"100%", height:"auto"}} src={"/personal_portfolio/images/projects/single-project4.jpg"} alt="gallery" />
                        </div>
                    </div>
                </div>
